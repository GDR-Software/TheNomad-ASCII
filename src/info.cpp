...
std::vector<weapon_t> wpninfo = {
	{ID(W_SHOTTY_ADB),    SHOTTY_ADB_STRING,    W_SHOTTY_ADB,    SHOTTY_ADB_DAMAGE,    SHOTTY_ADB_RANGE,    SHOTTY_RNG,SHOTTY_ADB_SPREAD, SHOTTY_ADB_MAGSIZE,    SHOTTY_ADB_NUMPELLETS},
	{ID(W_SHOTTY_FAB),    SHOTTY_FAB_STRING,    W_SHOTTY_FAB,    SHOTTY_FAB_DAMAGE,    SHOTTY_FAB_RANGE,    SHOTTY_RNG,SHOTTY_FAB_SPREAD, SHOTTY_FAB_MAGSIZE,    SHOTTY_FAB_NUMPELLETS},
	{ID(W_SHOTTY_QS),     SHOTTY_QS_STRING,     W_SHOTTY_QS,     SHOTTY_QS_DAMAGE,     SHOTTY_QS_RANGE,     SHOTTY_RNG,SHOTTY_QS_SPREAD,  SHOTTY_QS_MAGSIZE,     SHOTTY_QS_NUMPELLETS},
	{ID(W_SIDE_AUP),      SIDE_AUP_STRING,      W_SIDE_AUP,      SIDE_AUP_DAMAGE,      SIDE_AUP_RANGE,      SIDE_RNG,  BURST4_SPREAD,     SIDE_AUP_MAGSIZE,      0},
	{ID(W_SIDE_BOS),      SIDE_BOS_STRING,      W_SIDE_BOS,      SIDE_BOS_DAMAGE,      SIDE_BOS_RANGE,      SIDE_RNG,  SINGLE_SPREAD,     SIDE_BOS_MAGSIZE,      0},
	{ID(W_SIDE_FUSION),   SIDE_FUSION_STRING,   W_SIDE_FUSION,   SIDE_FUSION_DAMAGE,   SIDE_FUSION_RANGE,   SIDE_RNG,  BURST2_SPREAD,     SIDE_FUSION_MAGSIZE,   0},
	{ID(W_SIDE_ION),      SIDE_ION_STRING,      W_SIDE_ION,      SIDE_ION_DAMAGE,      SIDE_ION_RANGE,      SIDE_RNG,  SINGLE_SPREAD,     SIDE_ION_MAGSIZE,      0},
	{ID(W_SIDE_PLASMA),   SIDE_PLASMA_STRING,   W_SIDE_PLASMA,   SIDE_PLASMA_DAMAGE,   SIDE_PLASMA_RANGE,   SIDE_RNG,  SINGLE_SPREAD,     SIDE_PLASMA_MAGSIZE,   0},
	{ID(W_HSIDE_A8SHOT),  HSIDE_A8SHOT_STRING,  W_HSIDE_A8SHOT,  HSIDE_A8SHOT_DAMAGE,  HSIDE_A8SHOT_RANGE,  HSIDE_RNG, SHOTTY_QS_SPREAD,  HSIDE_A8SHOT_MAGSIZE,  1}, // slugs
	{ID(W_HSIDE_SADB),    HSIDE_SADB_STRING,    W_HSIDE_SADB,    HSIDE_SADB_DAMAGE,    HSIDE_SADB_RANGE,    HSIDE_RNG, SHOTTY_ADB_SPREAD, HSIDE_SADB_MAGSIZE,    4},
	{ID(W_PRIM_M23C5),    PRIM_M23C5_STRING,    W_PRIM_M23C5,    PRIM_M23C5_DAMAGE,    PRIM_M23C5_RANGE,    PRIM_RNG,  BURST3_SPREAD,     PRIM_M23C5_MAGSIZE,    0},
	{ID(W_PRIM_AK77),     PRIM_AK77_STRING,     W_PRIM_AK77,     PRIM_AK77_DAMAGE,     PRIM_AK77_RANGE,     PRIM_RNG,  AUTO_SPREAD,       PRIM_AK77_MAGSIZE,     0},
	{ID(W_PRIM_RAG15),    PRIM_RAG15_STRING,    W_PRIM_RAG15,    PRIM_RAG15_DAMAGE,    PRIM_RAG15_RANGE,    PRIM_RNG,  BURST2_SPREAD,     PRIM_RAG15_MAGSIZE,    0},
	{ID(W_PRIM_RAG14),    PRIM_RAG14_STRING,    W_PRIM_RAG14,    PRIM_RAG14_DAMAGE,    PRIM_RAG14_RANGE,    PRIM_RNG,  AUTO_SPREAD,       PRIM_RAG14_MAGSIZE,    0},
	{ID(W_PRIM_PLASMASMG),PRIM_PLASMASMG_STRING,W_PRIM_PLASMASMG,PRIM_PLASMASMG_DAMAGE,PRIM_PLASMASMG_RANGE,PRIM_RNG,  BURST3_SPREAD,     PRIM_PLASMASMG_MAGSIZE,0},
	{ID(W_HPRIM_FUSION),  HPRIM_FUSION_STRING,  W_HPRIM_FUSION,  HPRIM_FUSION_DAMAGE,  HPRIM_FUSION_RANGE,  HPRIM_RNG, SINGLE_SPREAD,     HPRIM_FUSION_MAGSIZE,  0},
	{ID(W_HPRIM_HOSIG),   HPRIM_HOSIG_STRING,   W_HPRIM_HOSIG,   HPRIM_HOSIG_DAMAGE,   HPRIM_HOSIG_RANGE,   HPRIM_RNG, SINGLE_SPREAD,     HPRIM_HOSIG_MAGSIZE,   0},
	{ID(W_HPRIM_RAG13),   HPRIM_RAG13_STRING,   W_HPRIM_RAG13,   HPRIM_RAG13_DAMAGE,   HPRIM_RAG13_RANGE,   HPRIM_RNG, SINGLE_SPREAD,     HPRIM_RAG13_MAGSIZE,   0},
	{ID(W_ARM_HB),        ARM_HB_STRING,        W_ARM_HB,        ARM_HB_DAMAGE,        ARM_HB_RANGE,        ARM_RNG,   BURST2_SPREAD,     0,                     0},
	{ID(W_ARM_GRAPPLE),   ARM_GRAPPLE_STRING,   W_ARM_GRAPPLE,   ARM_GRAPPLE_DAMAGE,   ARM_GRAPPLE_RANGE,   ARM_RNG,   SINGLE_SPREAD,     0,                     0}, // 6 shots till need a refill (TODO)
	{ID(W_ARM_HC),        ARM_HC_STRING,        W_ARM_HC,        ARM_HC_DAMAGE,        ARM_HC_RANGE,        ARM_RNG,   SHOTTY_ADB_SPREAD, SHOTTY_ADB_MAGSIZE,    SHOTTY_ADB_NUMPELLETS}, // 2 shots then ticker
	{ID(W_ARM_SB),        ARM_SB_STRING,        W_ARM_SB,        ARM_SB_DAMAGE,        ARM_SB_RANGE,        ARM_RNG,   BURST4_SPREAD,     1,                     0}, // 1 shot then ticker
	{ID(W_ARM_FT),        ARM_FT_STRING,        W_ARM_FT,        ARM_FT_DAMAGE,        ARM_FT_RANGE,        ARM_RNG,   BURST4_SPREAD,     1,                     0}, // 1 shot then ticker
};
